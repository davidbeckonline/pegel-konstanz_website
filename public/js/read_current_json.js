...
// date info
    ...
    document.getElementById("website__mostrecent_date").innerText = mostrecent_date;
    
    const mostrecent_time = konstante_data["mostrecent_time"];
    document.getElementById("website__mostrecent_time").innerText = mostrecent_time;    

// level info
    const current_level = konstante_data["current_level"];
    document.getElementById("website__current_level").innerText = current_level;

    const current_level_head = konstante_data["current_level"];
    document.getElementById("website__current_level_head").innerText = current_level_head;
  
    const change_vs_yesterday = konstante_data["change_vs_yesterday"];
    document.getElementById("website__change_vs_yesterday").innerText = change_vs_yesterday;

    const change_vs_yesterday_head = konstante_data["change_vs_yesterday"];
    document.getElementById("website__change_vs_yesterday_head").innerText = change_vs_yesterday_head;

// bridge info
    const current_level_bridge = konstante_data["current_level"];
    document.getElementById("website__current_level_bridge").innerText = current_level_bridge;

    const bridge_kn_left = konstante_data["bridge_kn_left"];
    document.getElementById("website__bridge_kn_left").innerText = bridge_kn_left;
    
    const bridge_kn_center = konstante_data["bridge_kn_center"];
    document.getElementById("website__bridge_kn_center").innerText = bridge_kn_center;
    
    const bridge_kn_right = konstante_data["bridge_kn_right"];
    document.getElementById("website__bridge_kn_right").innerText = bridge_kn_right;
